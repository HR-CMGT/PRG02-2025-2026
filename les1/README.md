...
**Greetings (ontwerp in tweetallen)**
...
> Werk de [opdracht](../start/index.php) uit in je persoonlijke map in de lesopdrachten folder.

- Bron: [Arrays](https://www.php.net/manual/en/language.types.array.php) in PHP.
- Bron: [Foreach](https://www.php.net/manual/en/control-structures.foreach.php) in PHP.
...
_Maak de onderstaande opdrachten om met verschillende onderwerpen te oefenen._

**Samenvoegen van string**

> Werk de [opdracht](strings/index.php) uit in de folder `exercises/strings`.

**Date time**

> Werk de [opdracht](date-time/index.php) uit in de folder `exercises/date-time`.
>
