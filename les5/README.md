...
In deze opdracht schrijf je de pseudo code voor de updatepagina. Hiervoor kun je gebruik maken van de flow chart die we zojuist in de les gemaakt hebben. 
